...
public class AmmoBar : MonoBehaviour
{
    ...
    public void Subscription()
    {
        ...
        FindObjectOfType<Player>().CurrentFirearm.magazine.onCurrentAmountChanged += UpdateBar;
    ...
    {
        var ammoAmount = FindObjectOfType<Player>().CurrentFirearm.magazine.CurrentAmount;
