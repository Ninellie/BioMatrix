...
{
    public class SideViewOldEnemyMoveController : OldEnemyMoveController
    {
        public SideViewOldEnemyMoveController(EnemyComponents.Enemy myUnit, GameObject target) : base(myUnit, target)
        {
        }
